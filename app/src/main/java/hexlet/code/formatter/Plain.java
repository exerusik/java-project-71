...
public class Plain {
    public static String getPlain(List <Node> mergeDataFromTwoFiles) throws Exception {
        ...
        for (Node element : mergeDataFromTwoFiles) {
            ...
            switch (description) {
                case "ADDED" :
                    buildString.append("Property \'" + element.getKey() + "\' was added with value: " + oldValue + "\n");
                    break;
                case "DELETE" :
                    buildString.append("Property \'" + element.getKey() + "\' was removed\n");
                    break;
                case "CHANGED" :
                    buildString.append("Property \'" + element.getKey() + "\' was updated. From " + oldValue + " to " + newValue + "\n");
                default:
                    break;
            }
        }
